...
class ClickHouseBatchTest extends TestCase
{
    private Usage $usage;
    ...
    protected function setUp(): void
    {
        ...
        $this->adapter->setUseFinal(true);
        $this->usage = new Usage($this->adapter);

        try {
            $this->usage->setup();
        } catch (\Exception $e) {
            $this->markTestSkipped('ClickHouse not available: ' . $e->getMessage());
        }
    }
